...
### encuentra el angulo entre el sphero y el pin al que hay que ir ###
...
### calcula la distancia entre los puntos para poder calcular la velocidad ###
...
def main():
    ...
    with SpheroEduAPI(toy) as bolt:  
        ...
        ### Asignar las coordenadas del robot inicial a su variable ###
        inicialRoboCoords = roboCoords
        ...
        print("Calculando Ángulo...", end =" ")
        start = [roboCoords[0][0], roboCoords[0][1]]
        target = [inicialRoboCoords[0][0],inicialRoboCoords[0][1]]
        angle = findangle(start,target)
        angle = angle - offset_angle
        if angle < 0:
            print("Es negativo")
